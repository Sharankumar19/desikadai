...
// node_modules/react-medium-image-zoom/dist/icons.js
...
// node_modules/react-medium-image-zoom/dist/utils.js
...
function Controlled(props) {
  return import_react2.default.createElement(ControlledBase, { ...props });
}
var ControlledBase = class extends import_react2.default.Component {
  constructor() {
    super(...arguments);
    this.state = {
      id: "",
    ...
    this.refContent = import_react2.default.createRef();
    this.refDialog = import_react2.default.createRef();
    this.refModalContent = import_react2.default.createRef();
    this.refModalImg = import_react2.default.createRef();
    this.refWrap = import_react2.default.createRef();
    this.imgEl = null;
  ...
  render() {
    ...
    if (hasImage) {
      const modalImg = isImg || isDiv ? import_react2.default.createElement("img", { alt: imgAlt, crossOrigin: imgCrossOrigin, sizes: imgSizes, src: imgSrc, srcSet: imgSrcSet, ...isZoomImgLoaded && modalState === "LOADED" ? zoomImg : {}, "data-rmiz-modal-img": "", height: this.styleModalImg.height || void 0, id: idModalImg, ref: refModalImg, style: this.styleModalImg, width: this.styleModalImg.width || void 0 }) : isSvg ? import_react2.default.createElement("div", { "data-rmiz-modal-img": true, ref: refModalImg, style: this.styleModalImg }) : null;
      const modalBtnUnzoom = import_react2.default.createElement(
        "button",
        { "aria-label": a11yNameButtonUnzoom, "data-rmiz-btn-unzoom": "", onClick: handleBtnUnzoomClick, type: "button" },
        import_react2.default.createElement(IconUnzoom, null)
      );
      modalContent = ZoomContent ? import_react2.default.createElement(ZoomContent, { buttonUnzoom: modalBtnUnzoom, modalState, img: modalImg, isZoomImgLoaded, onUnzoom: handleUnzoom }) : import_react2.default.createElement(
    ...
    return import_react2.default.createElement(
      ...
      import_react2.default.createElement(WrapElement, { "data-rmiz-content": dataContentState, ref: refContent, style: styleContent }, children),
      hasImage && import_react2.default.createElement(
        WrapElement,
        { "data-rmiz-ghost": "", style: styleGhost },
        import_react2.default.createElement(
          "button",
          { "aria-label": labelBtnZoom, "data-rmiz-btn-zoom": "", onClick: handleZoom, type: "button" },
          import_react2.default.createElement(IconZoom, null)
        )
      ),
      hasImage && import_react_dom.default.createPortal(import_react2.default.createElement(
        "dialog",
        ...
        import_react2.default.createElement("div", { "data-rmiz-modal-overlay": dataOverlayState }),
        import_react2.default.createElement("div", { "data-rmiz-modal-content": "", ref: refModalContent }, modalContent)
      ), this.getDialogContainer())
    );
  }
  componentDidMount() {
...
function Uncontrolled({ onZoomChange, ...props }) {
  const [isZoomed, setIsZoomed] = import_react3.default.useState(false);
  const handleZoomChange = import_react3.default.useCallback((value, { event }) => {
    setIsZoomed(value);
    onZoomChange == null ? void 0 : onZoomChange(value, { event });
  }, [onZoomChange]);
  return import_react3.default.createElement(Controlled, { ...props, isZoomed, onZoomChange: handleZoomChange });
}
export {
  Controlled,
