...
const Checkout = () => {
  ...
  if (cartItems?.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <h2 className="font-display text-3xl font-bold text-stone-700 mb-3">
          Your cart is empty
        </h2>
  ...
  const validate = () => {
    ...
    if (!form.name.trim() || form.name.trim().length < 2)
      newErrors.name = "Enter your full name (min 2 characters)";
        ...
        <div className="lg:col-span-3">
          <div className="card p-6">
            <h2 className="font-display text-xl font-semibold text-stone-800 mb-6 flex items-center gap-2">
              <span className="w-7 h-7 bg-moss text-white rounded-full flex items-center justify-center text-sm">
                1
              </span>
              Delivery Details
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="flex justify-start mt-4">
                <ReCAPTCHA
                  ...
                  onChange={(token) => {
                    console.log("Checkout CAPTCHA:", token);
                    setCaptcha(token);
                  }}
                />
              </div>
          ...
          <div className="card p-6 sticky top-24">
            ...
            <div className="border-t border-stone-100 mt-4 pt-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between text-stone-500">
                ...
                <span
                  className={
                    deliveryFee === 0 ? "text-forest-600 font-medium" : ""
                  }
                >
