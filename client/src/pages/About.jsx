...
const REVIEWS = [
  {
    ...
    rating: 5,
    review:
      "Excellent quality grow bags! Very strong and perfect for terrace gardening.",
  },
  {
    name: "Priya S",
    rating: 5,
    review:
      "Fast delivery and good packaging. Seeds germinated quickly. Highly recommended!",
  },
  {
    name: "Arun V",
    rating: 4,
...
const About = () => (
    ...
    <section className="bg-gradient-to-br from-forest-50 to-sage/10 py-20">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-stone-500 text-lg leading-relaxed max-w-2xl mx-auto">
          Desikadai was born from a simple idea — that plants have the power to
          transform spaces, improve wellbeing, and connect us with nature, even
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {REVIEWS.map((r, index) => (
            <div key={index} className="card p-6">
              ...
              {/* Name */}
              <p className="font-semibold text-stone-700 text-sm">– {r.name}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-stone-500 leading-relaxed mb-4">
            In 2025, our founder Boobalan started with a simple mission — to
            make gardening easy and accessible for everyone. What began as a
            small local business selling grow bags, fertilizers, and seeds
            quickly gained the trust of home gardeners.
          </p>

          <p className="text-stone-500 leading-relaxed mb-4">
            With a focus on quality and affordability, we carefully source
            durable grow bags, nutrient-rich fertilizers, and high-quality seeds
            that help plants grow healthier and stronger.
          </p>

          <p className="text-stone-500 leading-relaxed">
            Today, we proudly serve customers across South India, supporting
            thousands of people in building their own gardens — from balconies
            to backyards.
          </p>
        </div>
  ...
  <img
    ...
    alt="Farming"
    className="rounded-2xl w-full h-36 sm:h-40 md:h-48 object-cover md:-mt-6"
  />

  <img
    src="https://res.cloudinary.com/dyhe8bh7q/image/upload/v1776484034/WhatsApp_Image_2026-04-18_at_09.12.03_1_vocdpk.jpg"
    alt="Grow bags"
    className="rounded-2xl w-full h-36 sm:h-40 md:h-48 object-cover"
  />

  <img
    src="https://res.cloudinary.com/dyhe8bh7q/image/upload/v1776484033/WhatsApp_Image_2026-04-18_at_09.12.03_w4qopd.jpg"
    alt="Farming"
    className="rounded-2xl w-full h-36 sm:h-40 md:h-48 object-cover md:-mt-6"
  />

  <img
    src="https://res.cloudinary.com/dyhe8bh7q/image/upload/v1776484031/WhatsApp_Image_2026-04-18_at_09.11.51_vbdvxn.jpg"
    alt="Farming"
    className="rounded-2xl w-full h-36 sm:h-40 md:h-48 object-cover md:-mt-6"
  />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {TEAM.map(({ name, role, emoji, desc }) => (
            <div key={name} className="card p-6 text-center">
              ...
              <h3 className="font-display font-bold text-stone-800 mb-1">
                {name}
              </h3>
